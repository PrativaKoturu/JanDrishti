...
import { BarChart3, TrendingUp, Scale, AlertTriangle, Info, Calendar } from "lucide-react"
...
export default function HistoricalAnalysis({ selectedPollutant }: HistoricalAnalysisProps) {
  ...
  const timeRanges = [
    { id: "7d", label: "7 Days", icon: <Calendar className="w-4 h-4" />, days: 7 },
    { id: "30d", label: "30 Days", icon: <BarChart3 className="w-4 h-4" />, days: 30 },
    { id: "90d", label: "90 Days", icon: <TrendingUp className="w-4 h-4" />, days: 90 },
    { id: "1y", label: "1 Year", icon: <Calendar className="w-4 h-4" />, days: 365 },
  ]

  const viewTypes = [
    { id: "trend", label: "Trend Analysis", icon: <TrendingUp className="w-4 h-4" /> },
    { id: "comparison", label: "Week Comparison", icon: <Scale className="w-4 h-4" /> },
    { id: "seasonal", label: "Monthly Pattern", icon: <BarChart3 className="w-4 h-4" /> },
  ]
