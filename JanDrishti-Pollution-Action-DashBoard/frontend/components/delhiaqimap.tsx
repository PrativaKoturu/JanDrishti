...
const DelhiAQIMap: React.FC = () => {
  ...
  const fetchData = useCallback(async (isRefresh = false) => {
    ...
    try {
      ...
      const backendUrl = process.env.NEXT_PUBLIC_API_URL || process.env.NEXT_PUBLIC_BACKEND_URL || 'https://jan-drishti-eil9.vercel.app';
  ...
  useEffect(() => {
    ...
    console.log('Backend URL:', process.env.NEXT_PUBLIC_API_URL || process.env.NEXT_PUBLIC_BACKEND_URL || 'https://jan-drishti-eil9.vercel.app');
    fetchData();
  }, [fetchData]);
