...
import { Bot, FileText, AlertTriangle, Phone, Building2, Car, Globe, Heart, Factory, Droplets } from "lucide-react"
...
export default function PolicyRecommendations({ aqiData }: PolicyRecommendationsProps) {
  ...
  const sections = [
    { id: "recommendations", label: "AI Recommendations", icon: <Bot className="w-4 h-4" /> },
    { id: "regulations", label: "Current Regulations", icon: <FileText className="w-4 h-4" /> },
