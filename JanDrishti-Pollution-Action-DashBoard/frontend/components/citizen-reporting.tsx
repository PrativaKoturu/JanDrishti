...
export default function CitizenReporting({ selectedWard }: CitizenReportingProps) {
  ...
  const categories = [
    ...
    { id: "smoke", label: "Smoke/Burning", icon: <Wind className="w-4 h-4" /> },
    { id: "dust", label: "Construction Dust", icon: <Building2 className="w-4 h-4" /> },
    { id: "vehicle", label: "Vehicle Pollution", icon: <Car className="w-4 h-4" /> },
    { id: "industrial", label: "Industrial Waste", icon: <Factory className="w-4 h-4" /> },
    { id: "waste", label: "Waste Burning", icon: <Flame className="w-4 h-4" /> },
  ]
  ...
  const reportTabs = [
    { id: "reports", label: "Active Reports", icon: <ClipboardList className="w-4 h-4" /> },
    { id: "submit", label: "Submit Report", icon: <Plus className="w-4 h-4" /> },
